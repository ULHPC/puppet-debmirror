...
│   ├── ...             # Implementation of the other debmirror::* classes / definitions
...
├── pkg/                # Hold build packages to be published on the [Puppet forge](https://forge.puppetlabs.com/ULHPC/debmirror)
